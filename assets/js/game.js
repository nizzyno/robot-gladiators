...
var endGame = function () {
    ...
    if (playerHealth > 0) {
        ...
        window.alert(playerName + " has lost in battle! Game Over! You now have a score of " + playerMoney + ".");
    }
...
var shop = function () {
    ...
    console.log("Player health: " + playerHealth, "Robot attack power: " + playerAttack, "Player Money: " + playerMoney);
};
